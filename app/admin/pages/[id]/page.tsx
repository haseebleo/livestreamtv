...
export default function EditPagePage() {
  ...
  const [form, setForm] = useState<PageForm>({
    title: "", slug: "", content: "", status: "draft", metaTitle: "", metaDesc: "",
  });
  ...
  function set(field: keyof PageForm, value: string) {
    ...
    <div className="max-w-6xl mx-auto space-y-5">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-white">Edit Page</h1>
          ...
          <div className="rounded-xl p-5 space-y-4" style={{ background: "#141422", border: "1px solid #1e1e2e" }}>
            ...
            <div>
              ...
              <p className="text-xs mt-1" style={{ color: "#4b5563" }}>
                URL: <code className="text-purple-400">/{form.slug || "page-slug"}</code>
              </p>
            </div>
            <div>
