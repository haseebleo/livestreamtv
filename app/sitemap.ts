...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/pakistani-movies`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${BASE}/bollywood`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${BASE}/turkish-dramas`, lastModified: now, changeFrequency: "daily", priority: 0.88 },
    { url: `${BASE}/korean-dramas`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
